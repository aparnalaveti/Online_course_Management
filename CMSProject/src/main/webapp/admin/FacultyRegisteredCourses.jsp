                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <a href="FacultyRegisteredCourses.jsp"><h4>Faculty Registered Courses</h4></a>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="FacultyRegisteredCourses.jsp">Faculty Registered Courses</a></li>
                        </ol>
                    </div>
                </div>
										...
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<c:forEach items="${professors}"  var="p"> 
													<tr>
														<td>
														<img src='displayfacultyimage?id=${p.id}' class="rounded-circle" width="35" alt="">
														</td>
											...
											<div class="card-body pt-2">
												<div class="text-center">
													<div class="profile-photo">
														<img src='displayfacultyimage?id=${p.id}' width="100" class="img-fluid rounded-circle" alt="">
													</div>
