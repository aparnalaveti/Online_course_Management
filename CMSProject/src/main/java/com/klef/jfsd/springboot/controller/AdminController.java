	  ...
	  public ModelAndView checkadminlogin(HttpServletRequest request)
	  {
	   ...
	   @GetMapping("admin/add-student")
	    ...
	    return mv;
	      ...
	      public ModelAndView updateaction2(HttpServletRequest request,@RequestParam("courseimage") MultipartFile file) throws IOException, SerialException, SQLException
	      {
	        String msg = null;
	       ...
	       try
	       {
				...
				msg=adminService.updatecourse(c);
	            mv.setViewName("admin/displaymsg");
	            mv.addObject("message",msg);
